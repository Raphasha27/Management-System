...
Any information entered into the system is used to:
- Provide and maintain our IT Management Services.
- Improve system analytics and performance.
- Respond to support inquiries via the Call Center module.

## 3. Data Protection (Security)
We prioritize security as a core functional requirement:
- **Encryption**: All data in transit is encrypted via SSL/TLS (HTTPS).
- **Access Control**: Strict authentication middleware ensures data is only accessible to verified users.
- **No Third-Party Sharing**: We do NOT sell or share your data with third parties for marketing purposes.

## 4. User Rights
Users have the right to:
- Access their stored data within the system.
- Request the deletion of their mock data profiles.
